...
export THIS_DB_TEST="portfolio_test" # ganti ke nama database yang dipake untuk unit testing
export THIS_DB_DEV="portfolio" # ganti ke nama database yang dipake untuk development
